...
var Tag = function (_EventEmitter) {
   ...
   */
  function Tag(position, text,tagName) {
    ...
    _this.buttonElement = document.createElement('button');
     _this.buttonElement.innerHTML = tagName.id;
  ...
  (0, _createClass3.default)(Tag, [{
    ...
    value: function createFromObject(object) {
      return new Tag(object.position, object.text,object.id, object.buttonAttributes, object.popupAttributes);
    }
  }]);
  return Tag;
}(EventEmitter);
